...
if(x) return res.status(200).send({ status: true, message: `shorturl for this url is already generated `});
...
return res.status(201).send({status:true,message:'shorturl succesfully created'})
    }
catch(err){
